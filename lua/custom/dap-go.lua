local ts = require("custom.dap-go-ts")
...
local function setup_go_configuration(dap, configs)
  dap.configurations.go = {
    ...
    {
      type = "custom",
      name = "Connect Headless DLV 127.0.0.1:2345",
      request = "attach",
      mode = "remote",
    },
  }
...
local function setup_custom_dapter(dap)
  -- connect to runnning headless dlv
  dap.adapters.custom = {
    type = "server",
    host = "127.0.0.1",
    port = 2345,
